...
import com.example.nhommobile.Interface.IImageClickListenner;
import com.example.nhommobile.R;
import com.example.nhommobile.model.EventBus.TinhTongEvent;
import com.example.nhommobile.model.GioHang;
            ...
            public void onImageClick(View view, int pos, int giatri) {
                if (giatri == 1){
                    if (gioHangList.get(pos).getSoluong() > 1){
                        ...
                        builder.setMessage("Bạn có muốn hủy đặt sự lựa chọn xe của mình khỏi giỏ hàng hay không ?");
