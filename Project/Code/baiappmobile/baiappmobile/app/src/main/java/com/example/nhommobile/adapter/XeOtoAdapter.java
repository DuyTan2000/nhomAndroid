...
import com.example.nhommobile.Interface.ItemClickListener;
import com.example.nhommobile.R;
import com.example.nhommobile.activity.ChiTietActivity;
import com.example.nhommobile.model.SanPhamMoi;

import java.text.DecimalFormat;
import java.util.List;

public class XeOtoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
